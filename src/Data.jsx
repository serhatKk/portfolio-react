...
export const services = [
    ...
    "While creating applications using Windows Forms, I also design unique and compelling user interfaces that are user-friendly and functional" },
  {
    ...
    description:
    'Develop Python-based bots to automate tasks and streamline processes. Create intelligent bots for data scraping, analysis, and user interaction. Enhance productivity with custom bot solutions.'},
  {
    id: 3,
